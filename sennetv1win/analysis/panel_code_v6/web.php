...
Route::get('/' . config('v2board.secure_path', config('v2board.frontend_admin_path', hash('crc32b', config('app.key')))), function () {
    return view('admin', [
        ...
        'admin_theme_mode' => config('v2board.admin_theme_mode', 'classic'),
...
Route::get('/ctv/login', function () {
    return view('staff.login', ['staff_path' => 'ctv']);
});

Route::get('/ctv', function () {
    return view('staff.index', ['staff_path' => 'ctv']);
});
